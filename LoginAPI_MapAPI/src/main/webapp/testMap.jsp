...
//37.562856, 126.839956
var map = new naver.maps.Map("map", {
    center: new naver.maps.LatLng(37.562856, 126.839956), //37.562856, 126.839956 호서 직업전문학교 위치
    zoom: 18,
    mapTypeControl: true
});
</script>
...
var options = { //지도를 생성할 때 필요한 기본 옵션
	center: new kakao.maps.LatLng(37.562856, 126.839956), //지도의 중심좌표.
